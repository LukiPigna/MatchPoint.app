...
export const MATCH_LEVELS_CASUAL = ['Iniciación', 'Intermedio', 'Avanzado'];
...
export const ZONES = ['Norte', 'Sur', 'Oeste', 'Este', 'Centro'];
export const VENUES = [
    {
        id: 'v1',
    ...
    },
    {
        ...
        zone: 'Oeste',
        image: 'https://images.unsplash.com/photo-1599474924187-334a4ae5bd3c?q=80&w=1983&auto=format&fit=crop',
        courts: 8,
        rating: 4.9,
    },
];
